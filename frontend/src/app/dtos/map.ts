...
export class MapDto {
  ...
  constructor(id: number, northWestBoundary: Point2D, southWestBoundary: Point2D, northEastBoundary: Point2D, southEastBoundary: Point2D, center: Point2D, zoom: number) {
